    ...
    <main id="main-content" className="min-h-screen" style={{ background: "#F5F3FF" }}>
      ...
      <div style={{ maxWidth: "700px", margin: "0 auto", padding: "32px 24px" }}>
        ...
        <div style={introStyle}>
          Large PDF files are awkward to email, slow to upload, and consume unnecessary storage. PDF compression removes redundant metadata, embedded font duplicates, and structural inefficiencies without visibly degrading the document. This tool is most effective on PDFs that were generated by software that embeds full fonts and excessive structure data — such as those exported from Word, InDesign or older scanning software. Image-heavy PDFs such as photo portfolios may see less compression since the image data itself is already compressed. All processing happens in your browser — nothing is uploaded to a server.
        </div>
