    ...
    <>
      ...
      <div style={{ maxWidth: "800px", margin: "0 auto", padding: "0 24px 32px" }}>
        ...
        <div style={{ display: "flex", flexDirection: "column", gap: "10px" }}>
          {faqs.map((faq, i) => (
            <details key={i} style={{ background: "white", border: "0.5px solid #E0E7FF", borderRadius: "10px", padding: "0" }}>
              <summary style={{
                fontSize: "14px", fontWeight: "500", color: "#1E1B4B",
                cursor: "pointer", listStyle: "none", display: "flex",
                justifyContent: "space-between", alignItems: "center",
                padding: "16px"
              }}>
                {faq.q}
                <span aria-hidden="true" style={{ color: "#6366F1", fontSize: "18px", flexShrink: 0, marginLeft: "8px" }}>+</span>
              </summary>
              <p style={{
